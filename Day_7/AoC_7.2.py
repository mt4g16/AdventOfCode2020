...
def bag_count(count_lst):
    main_multiplier = count_lst[0]
    


ins_dic = gen_master(instructions)

final = flatten_toint(exhaustive_child(1, 'shiny gold bag'))

#print(final)

print(exhaustive_child(1, 'shiny gold bag'))
